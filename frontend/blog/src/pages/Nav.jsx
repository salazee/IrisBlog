...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-purple-600 to-midnightpurple text-white shadow-lg sticky top-0 z-50">
            ...
            {!isLoggedIn ? (
              ...
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-lg 
                           bg-darkpurple hover:bg-darkpurple transition-colors"
                >
            ...
            {!isLoggedIn ? (
              ...
              <>
                ...
                <Link
                  ...
                  onClick={() => setMenuOpen(false)}
                  className="flex items-center gap-2 px-4 py-2 rounded-lg 
                           hover:bg-white/10 bg-purple-300"
                >
                  <User className="w-5 h-5" />
                  Profile
                </Link>
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 
                           rounded-lg bg-darkpurple hover:bg-darkpurple transition-colors"
                >
                  <LogOut className="w-5 h-5" />
                  Logout
                </button>
